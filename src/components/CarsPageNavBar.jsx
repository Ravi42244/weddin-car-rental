...
{/* <MobileSideBar/> */}
     ...
     <nav className={`px-5 w-full py-1 flex justify-between items-center  text-white lg:sticky` }>
...
<Home className="mr-2 text-yellow-700 "/>
        ...
        <NavigationMenuItem className="">
          ...
          <NavigationMenuTrigger className="hover:data-[state=open]:text-white hover:data-[state=open]:bg-yellow-400 hover:bg-yellow-400 hover:text-white data-[state=open]:bg-yellow-400 data-[state=open]:text-white transition ease-in-out delay-150 "><div className="flex items-center  justify-between  ">
 ...
 <Link href={option.href} >
  {option.label}
      ...
      <Search className=" text-black my-2 mr-10 z-10"/>
        ...
        <Input className= {cn("w-full lg:-mr-16 lg:px-14 px-12 text-lg text-black -ml-20 md:w-1/2 border-none rounded focus-visible:ring-transparent shadow-lg shadow-yellow-400/30", session?.user?.email && `${'lg:mr-40'}`)}/>
...
<PopoverTrigger  >    <User2 className="text-black"/>
</PopoverTrigger>
<PopoverContent className="w-80 mt-3 h-52 flex flex-col items-center space-y-5 mr-5 ">
